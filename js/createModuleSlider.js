...
//     constructor(min, max, digitsAfterDot) {
//         // calculate adjustment factor
//         this.min = min;
//         this.max = max;
//         this.minlval = Math.log(min || 1);
...
//         return (Math.exp(position - this.min) * this.scale + this.minlval).toFixed(this.digitsAfterDot);
//     },
//     position: function(value) {
//         return (this.min + (Math.log(value || 1) - this.minlval)/ this.scale).toFixed(this.digitsAfterDot)
//     }
// }
